...
namespace Com.Rainier.Buskit3D
{
    ...
    public sealed class ObjectIdentity : IEquatable<ObjectIdentity>
    {
        ...
        /// 生成唯一ID
        /// </summary>
        /// <param name="idenity">ObjectIdentity对象</param>
        ...
        /// 判断是否唯一
        /// </summary>
        /// <param name="identity">ObjectIdentity对象</param>
        /// <returns>bool</returns>
        ...
        /// 重载
        /// </summary>
        /// <param name="a">ObjectIdentity对象</param>
        /// <param name="b">ObjectIdentity对象</param>
        /// <returns>bool</returns>
        ...
        /// </summary>
        /// <param name="identity">ObjectIdentity对象</param>
        public static implicit operator int(ObjectIdentity identity)
        {
            return identity.id;
        }
