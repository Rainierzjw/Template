...
* 版本声明：v1.0.0
* 项目名称：Com.Rainier.BusKit.Unity.InputSystem
...
namespace Com.Rainier.Buskit3D
{
    ...
    /// editor面板扩展
    /// </summary>
    [CustomEditor(typeof(RainierEventTriggerListener))]
    public class RainierEventTriggerListenerEditor : Editor
    {
        /// <summary>
        /// 绘制Inspector面板
        /// </summary>
        ...
        {
            RainierEventTriggerListener listener = (RainierEventTriggerListener)target;
            base.OnInspectorGUI();
        ...
        void Labe(RainierEventTriggerListener.VoidDelegate vo, string name, Action clearAction)
        {
            if (vo != null)
            {
