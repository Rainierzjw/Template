...
namespace Com.Rainier.Buskit3D
{
    ...
    public class ToggleViewModel : ViewModel
    {
        ...
        public void OnValueChange(Action<bool> onCoplete)
        {
            transform.GetComponent<Toggle>().onValueChanged.AddListener(onCoplete.Invoke);
        }

        public void RemoveValueChange()
        {
            transform.GetComponent<Toggle>().onValueChanged.RemoveAllListeners();
        }
    }
}
