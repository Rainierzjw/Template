...
namespace Com.Rainier.Buskit3D.WebGLInputField
{
    ...
    public class InputWebGLManage : MonoBehaviour
    {
        ...
        public static Dictionary<int, InputField_WebGL> GameObjectID_InputField = new Dictionary<int, InputField_WebGL>();

        public void InputShow(string inputID, string text, string fontsize, string indexStr, string inputRectStr, bool isMultiNewLine,bool readOnly)
        {
            ChineseInputWebGL.InputShow(gameObject.name, inputID, text, fontsize, indexStr, inputRectStr, isMultiNewLine, readOnly);
        }
